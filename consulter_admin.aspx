<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="consulter_admin.aspx.cs" Inherits="consulter_admin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Body" Runat="Server">
<body  style="background-color:#2A2A6C;">
<h1 style="margin-left:650px;color:#E3761C;">Les administrateurs</h1>
 <div class="card mb-3" style="width:100%; margin-left:250px; margin-top:50px;">
     ...
     <asp:GridView ID="dataTables" class="table table-bordered"  width="80%" cellspacing="0" 
                    ...
                    OnRowCommand ="datables_rowCommand" AllowPaging="True"  PageSize="8" 
