<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="modifier.aspx.cs" Inherits="Default2" %>
...
<form ID="f">
  <div class="container" style="width:100%; margin-left:300px; margin-top:20px;">
    <h1 style="color:#E3761C;">Modifier utilisateur</h1>
  <div> <p style="color:#E3761C;">Voulez appliquez les modifications relative au user </p>
      ...
      <asp:Button ID="Button1" runat="server" Text="Afficher" 
          onclick="afficherFormulaire_Click" />
    <hr>
  ...
  <!-- <label for="email"><b>Email</b></label>
    <input type="text" placeholder="Enter Email" name="email" required>-->
     <asp:Label ID="prenom" style="color:#E3761C;" runat="server" Text="Label">prenom</asp:Label>
      <asp:TextBox ID="prenom_s" class="input"  runat="server"></asp:TextBox>
       
         <asp:Label ID="mail" style="color:#E3761C;" runat="server" Text="Label">Email</asp:Label>
      ...
      <asp:Label ID="matricule" style="color:#E3761C;" runat="server" Text="Label">Matricule</asp:Label>
      <asp:TextBox ID="matricule_s" class="input" runat="server"></asp:TextBox>
        
        <asp:Label ID="tel" style="color:#E3761C;" runat="server" Text="Label">numéro téléphone</asp:Label>
      <asp:TextBox ID="tel_s" class="input" runat="server"></asp:TextBox>
    
  
   <asp:Label ID="type" style="color:#E3761C;" runat="server" Text="Label">Type :</asp:Label>   
   
        <asp:DropDownList ID="a" class="input" runat="server">
        <asp:ListItem>Admin</asp:ListItem>
        <asp:ListItem>Super user</asp:ListItem>
        </asp:DropDownList>
        <asp:Label ID="type_defaut" style="color:#E3761C;" runat="server" Text="Label">Etat:</asp:Label>
     
              <asp:RadioButtonList ID="etat" class="input" runat="server">
               <asp:ListItem Value="active" Text="Activé"></asp:ListItem>
               <asp:ListItem Value="desactive" Text="Désactivé"></asp:ListItem>
               </asp:RadioButtonList>
