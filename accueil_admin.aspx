...
<body style="background-color:#2A2A6C;" >
 <div>
    ...
    <div class="page">
      ...
      <!-- What We Offer-->
      <section class="section section-md bg-default" style="margin-left:150px;margin-top:0px; width:100%;">
        <div class="container">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span ></span>
                    <h5 class="services-terri-title"><a href="ajout_candidat.aspx">Ajouter utilisateur</a></h5>
                  </div>
                </article>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span></span>
                    <h5 class="services-terri-title"><a href="examen1.aspx">Créer examen</a></h5>
                  </div>
                </article>
              ...
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="images/affecter.png" alt="" width="370" height="278"/>
                  </div>
                  <div class="services-terri-caption"><span></span>
                    <h5 class="services-terri-title"><a href="consulter_examen.aspx">Consulter examen</a></h5>
                  </div>
                </article>
              ...
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="images/examm.png" alt="" width="370" height="278"/>
                  </div>
                  <div class="services-terri-caption"><span></span>
             ...
             <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Services Terri-->
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="images/question.png" alt="" width="370" height="278"/>
                  </div>
                  <div class="services-terri-caption"><span></span>
                    <h5 class="services-terri-title"><a href="preparer_question.aspx"> préparer questions</a></h5>
                  </div>
                </article>
